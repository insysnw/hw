package net.fennmata.amogus.terminal.client.infrastructure
...
open class ApiClient(val baseUrl: String) {
    companion object {
        ...
        const val baseUrlKey = "net.fennmata.amogus.terminal.client.baseUrl"
    ...
    protected inline fun <reified T : Any?> responseBody(body: ResponseBody?, mediaType: String? = JsonMediaType): T? {
        ...
        if (T::class.java == File::class.java) {
            // return tempfile
            val f = java.nio.file.Files.createTempFile("tmp.net.fennmata.amogus.terminal.client", null).toFile()
            f.deleteOnExit()
    ...
    protected fun <T> updateAuthParams(requestConfig: RequestConfig<T>) {
        if (requestConfig.headers["Identity"].isNullOrEmpty()) {
            if (apiKey["Identity"] != null) {
                if (apiKeyPrefix["Identity"] != null) {
                    requestConfig.headers["Identity"] = apiKeyPrefix["Identity"]!! + " " + apiKey["Identity"]!!
                } else {
                    requestConfig.headers["Identity"] = apiKey["Identity"]!!
                }
            }
        }
    }
